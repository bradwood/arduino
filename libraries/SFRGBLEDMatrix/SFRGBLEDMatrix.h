...
class SFRGBLEDMatrix {
  ...
  public:
	...
	//Brad's week printing method -- uses the week font
    //void printweek(const Color color, const int x, const int y, const char c);
    // paint single pixel
    ...
    // draw vertical line
    void line_vert(const Color color, const int x0, const int y0, const int y1);
    // draw line
   //void line(const Color color, const int x0, const int y0, const int x1, const int y1);
